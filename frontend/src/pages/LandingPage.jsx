...
import { 
  ...
  Zap, Heart, Globe, ChevronDown, GraduationCap, Menu, X,
  CheckCircle2, Star, TrendingUp, Bell, FileText
} from 'lucide-react'
      ...
      <nav className={`fixed top-0 left-0 right-0 z-50 transition-all duration-300 border-b ${scrolled ? 'bg-white/90 backdrop-blur-md border-slate-200 py-3 shadow-sm' : 'bg-transparent border-transparent py-5'}`}>
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 flex items-center justify-between">
          ...
          <div className="hidden md:flex items-center gap-8">
            {navLinks.map((link) => (
              <a key={link.name} href={link.href} className="text-sm font-medium text-slate-600 hover:text-emerald-700 transition-colors">
                {link.name}
              </a>
            ))}
        ...
        {mobileMenuOpen && (
          <div className="md:hidden absolute top-full left-0 right-0 bg-white border-b border-slate-200 shadow-lg py-4 px-4 space-y-3">
            {navLinks.map((link) => (
              <a key={link.name} href={link.href} onClick={() => setMobileMenuOpen(false)} className="block text-sm font-medium text-slate-600 hover:text-emerald-700 py-2">
                {link.name}
              </a>
            ))}
          ...
          <div className="grid lg:grid-cols-2 gap-12 lg:gap-8 items-center">
            <div className="max-w-2xl">
              <div className="inline-flex items-center gap-2 px-3 py-1.5 bg-emerald-50 border border-emerald-100 text-emerald-700 rounded-full text-xs font-bold uppercase tracking-wider mb-6">
                ...
                2026 Academic Year Now Open
              </div>
              
              <h1 className="text-4xl sm:text-5xl lg:text-6xl font-extrabold tracking-tight text-slate-900 leading-[1.1] mb-6">
                The Official Digital Hub for <span className="text-transparent bg-clip-text bg-gradient-to-r from-emerald-600 to-teal-600">LOTUBAE Students</span>
              </h1>
              
              <p className="text-lg text-slate-600 leading-relaxed mb-8 max-w-lg">
                One platform for membership, events, elections, contributions, and real-time communication. Built exclusively for the LOTUBAE Student Association.
              </p>
      ...
      <section id="features" className="py-24 bg-white">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center max-w-3xl mx-auto mb-16">
            ...
            <p className="text-slate-600 text-lg">From digital membership cards to secure elections, LOTSA CONNECT handles it all so you can focus on what matters.</p>
          </div>
          ...
          <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-8">
            ...
            <FeatureCard 
              ...
              desc="Discover upcoming events, RSVP instantly, and receive reminders. From academic seminars to cultural celebrations."
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <div className="grid md:grid-cols-3 gap-8 relative">
            ...
            {[
              ...
              { step: '02', title: 'Get Membership', desc: 'Pay Ksh 100 via M-Pesa Paybill 254254, Account 12345678, and receive your digital card.', icon: CheckCircle2 },
            ...
            <div className="relative grid md:grid-cols-2 gap-12 items-center">
              <div>
                ...
                <blockquote className="text-2xl md:text-3xl font-bold text-white leading-relaxed mb-6">
                  "LOTSA CONNECT transformed how we engage with students. Elections are fair, events are organized, and communication has never been easier."
                </blockquote>
      ...
      <section className="py-24 bg-emerald-600 relative overflow-hidden">
        ...
        <div className="relative max-w-4xl mx-auto px-4 text-center">
          ...
          <p className="text-emerald-100 text-lg mb-10 max-w-2xl mx-auto leading-relaxed">
            Become a verified member today and unlock full access to voting, events, exclusive announcements, and direct communication with student leadership.
          </p>
          ...
          <div className="grid md:grid-cols-4 gap-12 mb-12">
            <div className="md:col-span-2">
              ...
              <p className="text-slate-400 leading-relaxed max-w-sm mb-6">
                The official digital platform of the LOTUBAE Student Association. Empowering students through technology, transparency, and community.
              </p>
